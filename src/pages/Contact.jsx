...
const Contact = () => {
  ...
  const socials = [
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/billeddy.saliu?igsh=NGh6dm5taTQ0Yzd0&utm_source=qr',
      icon: (
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.1 1.82 2.9 2.9 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.26 6.26 0 0 0-1-.1 6.27 6.27 0 1 0 10.25 5.16V9.01a8.04 8.04 0 0 0 4.57 1.18v-3.45a4.7 4.7 0 0 1-.57-.05z" />
        </svg>
      ),
    },
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/share/1Ezy7n4bgi/?mibextid=wwXIfr',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'YouTube',
      href: 'https://www.youtube.com/@billeddysaliu',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/in/billeddy-saliu-901303222/',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
